...
export default function Footer() {
    return (
        <footer className="grid mx-auto max-w-md md:max-w-3xl md:grid-cols-2 lg:grid-cols-footer lg:max-w-8xl bg-white">
            <div>
            ...
            <div className="mx-8 my-16 flex items-center justify-center md:col-span-2 lg:col-span-1 lg:mx-12 lg:my-8">
                <div className="space-y-4">
                    <h2 className="text-sm font-bold tracking-[0.4375rem] leading-[1.375rem] uppercase md:text-base">About our furniture</h2>
                    <p className="text-gray-600 font-medium tracking-[-0.33px] leading-[1.375rem]">
